...
create user user_react@localhost identified by '1111';
grant all privileges on db_react.* to user_react@localhost;
ALTER USER 'user_react'@'localhost' IDENTIFIED WITH mysql_native_password BY '1111';
FLUSH PRIVILEGES;
